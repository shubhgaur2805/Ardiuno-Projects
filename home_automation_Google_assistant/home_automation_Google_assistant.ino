...
#define WLAN_SSID       "BSNL FIBER"             // Your SSID
#define WLAN_PASS       "shubh"        // Your password

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com" //Adafruit Server
#define AIO_SERVERPORT  1883                   
#define AIO_USERNAME    "shubhgaur"            // Username
...
void setup() {
  ...
  WiFi.begin(WLAN_SSID, WLAN_PASS);  //connect to network
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(20000))) {
    if (subscription == &Light1) {
      ...
      digitalWrite(Relay1, Light1_State); //output
